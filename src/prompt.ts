...
export const KEYWORD_EXTRACTOR_PROMPT = "You are a smart keyword extractor. Given a product-related query, your task is to guess around 50 of the most relevant search keywords for product discovery. Include a mix of short one-word keywords such as shoes, summer, men, and longer multi-word keywords such as linen shirt, casual outfit, yellow t-shirt. Only return a plain list of keywords separated by commas. Do not include any JSON, colons, labels, markdown, or formatting. Respond with only the keywords.";
